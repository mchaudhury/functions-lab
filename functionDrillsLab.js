...
function faveColorFinder(color) {
  if (color === "red") {
    ...
    console.log("green is asolid favorite color");
  } else if (color === black) {
...
function newUppercase(string) {
  console.log(string.toUpperCase());
}

newUppercase(sampleString);
...
let totalFrogs = chocolateBuyer(30);
...
let totalFrogs2 = chocolateBuyer2(35);
...
/*
 ...
 In the body of the function, write logic to determine if the array is in ascending order. The function should return true, if it is sorted in ascending order, false if it is not. 
